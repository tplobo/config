...
# Disable Finder window animations and Get Info animations (true | false)
...
# Set other paths as the default location for new Finder windows
...
# Use same view in all Finder windows by default
...
test -f ~/Library/com.apple.FinderInfo && xattr -d com.apple.FinderInfo ~/Library
